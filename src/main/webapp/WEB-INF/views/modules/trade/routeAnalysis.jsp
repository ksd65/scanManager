...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			...
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/trade/analysis/route");
			$("#searchForm").submit();
        	return false;
        }
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/trade/analysis/route">通道交易分析</a></li>
		<li><a href="${ctx}/trade/analysis/routeMerchant">通道子商户交易分析</a></li>
		<li><a href="${ctx}/trade/analysis/member">下游商户交易分析</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="tradeAnalysis" action="${ctx}/trade/analysis/route" method="post" class="breadcrumb form-search">
		<ul class="ul-form">
			 <li><label>通道：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<tbody>
		<c:forEach items="${list}" var="tradeAnalysis">
			<tr>
				<td>
