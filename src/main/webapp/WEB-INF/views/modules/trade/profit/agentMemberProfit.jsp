...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
			...
			if(n) $("#pageNo").val(n);
			if(s) $("#pageSize").val(s);
			$("#searchForm").attr("action","${ctx}/trade/profit/agentMember");
			$("#searchForm").submit();
        	return false;
        }
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/trade/profit/agent">按代理商统计</a></li>
		<li  class="active"><a href="${ctx}/trade/profit/agentMember">按商户统计</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="tradeProfit" action="${ctx}/trade/profit/agentMember" method="post" class="breadcrumb form-search">
...
function getSumData(){
	...
	$.ajax({
        ...
        data: "memberName="+memberName+"&beginTime="+beginTime+"&endTime="+endTime+"&agentName="+agentName,
