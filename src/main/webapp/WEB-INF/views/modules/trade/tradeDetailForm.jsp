...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/trade/tradeDetail/">交易明细列表</a></li>
		<li class="active"><a href="${ctx}/trade/tradeDetail/form?id=${tradeDetail.id}">交易明细<shiro:hasPermission name="trade:tradeDetail:edit">${not empty tradeDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="trade:tradeDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="tradeDetail" action="${ctx}/trade/tradeDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="orderCode" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">交易类型 1:微信 2:支付宝：</label>
			<div class="controls">
				<form:input path="txnType" htmlEscape="false" maxlength="1" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">借贷记类型 1:借记 2:贷记 3:其他：</label>
			<div class="controls">
				<form:input path="cardType" htmlEscape="false" maxlength="1" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">支付通道ID：</label>
			<div class="controls">
				<form:input path="routeId" htmlEscape="false" maxlength="5" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="payDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${tradeDetail.payDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="balanceDate" htmlEscape="false" maxlength="10" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">支付渠道流水号：</label>
			<div class="controls">
				<form:input path="channelNo" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">结算类型 0:D+0 1:T+1：</label>
			<div class="controls">
				<form:input path="settleType" htmlEscape="false" maxlength="1" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">清算撤销标识：</label>
			<div class="controls">
				<form:input path="settleCancelFlag" htmlEscape="false" maxlength="1" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="trade:tradeDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
