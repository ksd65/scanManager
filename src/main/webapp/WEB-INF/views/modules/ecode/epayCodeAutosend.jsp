...
<body>
	...
	<form id="searchForm" class="breadcrumb form-search" action="${ctx}/ecode/epayCode/autosend" method="post">		
			<h3 style="width:100%;text-align:center">自动分发二维码设置</h3>
			<h5 style="color:#FF0000">功能说明：</h5>
			<div>
			<ul style="color:#FF0000">
				<li>
					<span><b>代理商通过此功能，可批量设置二维码为自动分发状态</b> </span>
				</li> 
				<li>
					<span><b>设置完成后，通过代理商专属二维码注册的商户按顺序获取自动分发状态的二维码进行匹配</b> </span>
				</li>
				<li>
			...
			<table>
				...
				<tr>
				<td colspan="2" style="text-align: center;"><input id="btnSubmit" class="btn btn-primary" style="width: 80px;" type="submit" value="配置"/></td>
				</tr>
			</table>
	</form>
</body>
