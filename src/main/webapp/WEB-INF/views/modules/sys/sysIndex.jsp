...
<html>
<head>
	<title>${empty agentConfig ? fns:getConfig('productName') : agentConfig.agentName}</title>
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="productName">${empty agentConfig ? fns:getConfig('productName') : agentConfig.agentName}</span></div>
	    ...
	    <div class="container-fluid">
		    ...
		    <c:choose>
			   ...
			   <c:otherwise>
			   		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="" target="_blank">ScanPay</a> ${fns:getConfig('version')}
			   </c:otherwise>
			</c:choose> 
	       </div>
		</div>
