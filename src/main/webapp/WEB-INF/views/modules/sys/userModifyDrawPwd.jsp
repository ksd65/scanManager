...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/user/modifyDrawPwd">修改提现密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/modifyDrawPwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">旧提现密码:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">新提现密码:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">确认新提现密码:</label>
			<div class="controls">
